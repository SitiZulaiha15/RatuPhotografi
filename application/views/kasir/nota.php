                        ...
                        <div class="row">
                            <div class="col-xs-6">
                                <address>
                                    ...
                                    <?php echo $this->Kasir_m->staf_nm($n->id_kasir); ?>
                                </address>
                            </div>
                            <div class="col-xs-6 text-right">
                                <address>
                                    <strong>Order Date:</strong><br>
                                    <?php echo $n->tgl; ?><br><br>
                                </address>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            <?php if ($b->dp <> 0) { ?>
                                                ...
                                                <td class="no-line"></td>
                                                    ...
                                                    <td class="no-line text-right" colspan="3"><?php echo $this->Etc->rp($b->dp); ?></td>
                                                </tr>
                                            <?php } ?>
                                            <tr>
                                                <td class="no-line"></td>
                                                <td class="no-line"></td>
                                                <td class="no-line text-center"><strong>Tunai</strong></td>
                                                <td class="no-line text-right" colspan="3"><?php echo $this->Etc->rp($a); ?></td>
                                            </tr>
                                            <tr>
                                                <td class="no-line"></td>
                                                <td class="no-line"></td>
                                                <td class="no-line text-center"><strong>Kembali</strong></td>
                                                <td class="no-line text-right" colspan="3"><?php echo $this->Etc->rp($a - ($total + $diskon)); ?></td>
                                            </tr>
                                            <tr class="tombol">
