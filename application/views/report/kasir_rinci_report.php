                    ...
                    <div class="col-md-12">
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title"><strong>Laporan Rincian Penjualan <?php echo $this->Etc->tgl($start); ?> - <?php echo $this->Etc->tgl($end); ?></strong></h3>
                            </div>
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($report as $r) {
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-right"><?php $t=$this->Report_m->t_trans($r->id_trans);
                                                echo $this->Etc->rps($t);
                                                ?></td>
