...
<div class="container">
    <div class="row">
        <div class="modal fade left" id="history_pindah_uang" tabindex='-1'>
    ...
    <h4 class="panel-title">
        <a style="text-decoration: none" data-toggle="collapse" data-parent="#accordion" href="#collapsePindahUang">
    ...
    <div id="collapsePindahUang" class="panel-collapse collapse">
        <div class="panel-body">
            <?php $this->load->view('jurnal/pindah_uang') ?>
        </div>
    </div>
    <a data-toggle="modal" data-target="#history_pindah_uang    " class="float" title="history keuangan"> 
        <i class="fa fa-history my-float "onclick="return printDiv('print')"></i>
    </a>
    <script>
