                ...
                <div class="container">
                    ...
                    <table style="margin: 0 auto; color: #000;" class="table table-condensed table-striped">
                        ...
                        if (sizeof($kelompok_value) == 0) {
                            ...
                            foreach ($kelompok_value as $value) {
                                $histori = $total + $value->totalDebit - $value->totalKredit;
                                ?><tr>
                                    <td><?php echo $i + 1 ?></td>
                                    <td><?php echo $value->Akun ?></td>
                                    <td><?php echo buatrp($value->totalDebit) ?></td>
                                    <td><?php echo buatrp($value->totalKredit) ?></td>
                                </tr>
                                <?php
